...
def draw_nav_bar(surface:object,elements:list,x_margin:int,y_margin:int,selected:str):
    ...
    return largest_button + x_margin, button_dict
...
def draw_page_songs():
    pass
def draw_page_artists():
    pass
def draw_page_albums():
    pass
def draw_page_playlists():
    pass
def draw_page_search():
    pass